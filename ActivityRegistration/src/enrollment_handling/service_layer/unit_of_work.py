...
from enrollment_handling.adapters import repository


class AbstractUnitOfWork(abc.ABC):
    enrollments: repository.AbstractRepository
...
class SqlAlchemyUnitOfWork(AbstractUnitOfWork):
    ...
    def __enter__(self):
        ...
        self.enrollments = repository.SqlAlchemyRepository(self.session)
